...
This [Helm](https://helm.sh/) chart installs [Apache NiFi](https://nifi.apache.org/) 2.0.0-M3 in a [Kubernetes](https://kubernetes.io/) cluster.
...
```bash
helm install my-nifi improwised/nifi
```
...
To uninstall/delete the `my-nifi` deployment:
...
my-nifi-0             3/4     Failed    1          56m
my-nifi-registry-0    1/1     Running   0          56m
my-nifi-zookeeper-0   1/1     Running   0          56m
my-nifi-zookeeper-1   1/1     Running   0          56m
my-nifi-zookeeper-2   1/1     Running   0          56m
```

Inspect the pod, check the "Events" section at the end for anything suspicious.

```bash
kubectl describe pod my-nifi-0
```
